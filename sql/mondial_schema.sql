...
REVOKE ALL ON DATABASE MONDIAL FROM PUBLIC;
REVOKE ALL ON SCHEMA public FROM PUBLIC;
REVOKE ALL PRIVILEGES ON DATABASE postgres FROM MONDIALUSER;

GRANT ALL PRIVILEGES ON DATABASE MONDIAL TO MONDIALUSER;
GRANT CONNECT ON DATABASE MONDIAL TO MONDIALUSER;

\c MONDIAL

ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT SELECT ON TABLES TO MONDIALUSER;
...
ALTER TABLE citypops DISABLE TRIGGER ALL;
