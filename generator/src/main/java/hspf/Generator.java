...
public class Generator implements IGeneratorService {
        ...
        for (Field field : table.getFields()) {
            switch (field.getName()) {
                case "ArticleId":
                    ...
                    row.putValue("SalesVolume", String.valueOf(amount * articlePriceMap.get(articleId)));
                    break;
                case "CustomerId":
                ...
                case "TimeId":
                    ...
                    break;
                case "StoreId":
                    row.putValue(field.getName(), pickStoreId(row.getValue("CustomerId")));
            }
        }
        return row;
    }
    ...
    private String generateArticleId(Field field) {
        ...
        } while (randomNumber >= 71 && randomNumber <= 100 || randomNumber >= 111 && randomNumber <= 120);
